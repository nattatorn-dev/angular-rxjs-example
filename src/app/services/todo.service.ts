...
const initialTodos: Todo[] = JSON.parse(localStorage.getItem('angular-rxjs-example')) || [];
...
export class TodoService {
  ...
  constructor() {
    ...
    this.todos$.forEach(todos => localStorage.setItem('angular-rxjs-example', JSON.stringify(todos)));
